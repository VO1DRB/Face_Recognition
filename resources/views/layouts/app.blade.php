...
<body class="font-sans antialiased">
    <div class="min-h-screen flex bg-gray-100">
        ...
        <!-- Sidebar -->
        <aside class="fixed top-0 left-0 w-64 h-screen bg-gray-50 text-gray-800 flex flex-col shadow-md">
            <!-- Logo -->
            ...
            <div class="p-4 border-t border-gray-200 bg-white">
                <a href="{{ route('profile.edit') }}"
                    class="flex items-center mb-3 hover:bg-gray-100 p-2 rounded-md transition">
                    <div
                        class="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center font-bold text-gray-700">
        ...
        <div class="flex-1 flex flex-col ml-64">
            <!-- kasih ml-64 biar ga ketimpa sidebar -->
            <!-- Navigation atas -->
